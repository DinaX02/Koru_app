        ...
        <GestureHandlerRootView style={styles.container}>
            ...
            <View style={styles.status}>
                <View style={styles.statustext}>
                    <Text style={styles.statustexttags}><Text style={styles.statusgrey}>Status:</Text> Open</Text>
                    <Image
                ...
                <Text style={styles.statustexttags}><Text style={styles.statusgrey}>closes at:</Text> 18:30</Text>
            </View>
            <View style={styles.wallet}>
                ...
                <Image style={styles.walleticon} source={require("../assets/log_out.png")}></Image>
            </View>
                <ScrollView contentContainerStyle={styles.projects}>
                    ...
                    >
                        <Image style={styles.projectimage} source={require("../assets/event_join.png")}></Image>
                        <Text>Koru</Text>
                    </TouchableOpacity>
                ...
                >
                    ...
                    >
                        ...
                        <Text style={styles.slidertitle}>Koru</Text>
                            <Text style={styles.sliderdescription}>Koru is an event tracking platform that allows organizers to create and manage events efficiently, while providing event attendees with a personalized and interactive experience. The app focuses on the dynamics of voting on projects displayed at the event, where participants have coins they can invest in the projects they like the most. Link:  Koru_link.com</Text>
                        </View>
                    </Animated.View>
                </PanGestureHandler>
